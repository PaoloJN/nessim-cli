...
import { Icons } from '{alias}components/ui/icons'
...
function addSignInPage(options: CLIOptions) {
    const { alias, uiLibrary, src } = options;
    const signInPagePath = src
        ? "src/app/sign-in/[[...sign-in]]/page.tsx"
        : "app/sign-in/[[...sign-in]]/page.tsx";

    if (uiLibrary === "shadcn-ui") {
        createFile(signInPagePath, clerkSignInPage.shadcn.replace(/{alias}/g, alias));
    } else {
        createFile(signInPagePath, clerkSignInPage.default);
    }

    logger.success(`Writing ${chalk.cyan("sign-in/[[...sign-in]]/page.tsx")} - Clerk Auth`);
}

export default addSignInPage;
